...
initial begin 
  ...
  x_file = $fopen("text_files/activation_tile0.txt", "r");
  ...
  for (kij=0; kij<9; kij=kij+1) begin  // kij loop
    ...
    case(kij)
     0: w_file_name = "text_files/weight_itile0_otile0_kij0.txt";
     1: w_file_name = "text_files/weight_itile0_otile0_kij1.txt";
     2: w_file_name = "text_files/weight_itile0_otile0_kij2.txt";
     3: w_file_name = "text_files/weight_itile0_otile0_kij3.txt";
     4: w_file_name = "text_files/weight_itile0_otile0_kij4.txt";
     5: w_file_name = "text_files/weight_itile0_otile0_kij5.txt";
     6: w_file_name = "text_files/weight_itile0_otile0_kij6.txt";
     7: w_file_name = "text_files/weight_itile0_otile0_kij7.txt";
     8: w_file_name = "text_files/weight_itile0_otile0_kij8.txt";
    endcase
  ...
  // with no parallelism 
    ...
    // -----------------------------------------------------------------------
    // VISUAL VERIFICATION OF OFIFO CONTENTS
    // -----------------------------------------------------------------------
    // $display("// -----------------------------------------------------------------------");
    ...
    //////// OFIFO READ ////////
    // THE NOTE BELOW IS NOW IMPLEMENTED IN THE EXECUTION STEP !!
  ...
  ////////// Accumulation /////////
  out_file = $fopen("text_files/out.txt", "r");  
